...
You can adjust the number of simulations performed by MCTS by changing the number of iterations in the for loop in the monte_carlo_tree_search function. More simulations will generally result in better decisions but will also take longer
