...
if __name__ == "__main__":
    main()
This main function is the same as before except that it now uses the updated realizar_movimiento_bot function that uses the minimax algorithm to determine the best move for the bot. This means that when it is the bot’s turn to move, it will use the minimax algorithm to determine its move instead of making a random move.
