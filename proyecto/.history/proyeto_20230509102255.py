...
def score(tablero, tamaño):
    ...
    return score
También puedes aumentar la profundidad máxima del algoritmo minimax para permitir que el bot mire más adelante y tome decisiones más informadas. Puedes hacerlo aumentando el valor de max_depth en la función iterative_deepening. Por ejemplo, para aumentar la profundidad máxima a 5, puedes cambiar la línea best_move = iterative_deepening(tablero,tamaño,tamaño**2) a best_move = iterative_deepening(tablero,tamaño,5).

Sin embargo, ten en cuenta que aumentar la profundidad máxima también aumentará la complejidad computacional del algoritmo y puede resultar en tiempos de espera más largos entre movimientos.
